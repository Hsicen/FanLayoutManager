...
import com.hsicen.library.java.gallery.AnimManager;
import com.hsicen.library.java.gallery.GalleryRecyclerView;
import com.hsicen.library.java.gallery.OsUtil;
...
public class GalleryActivity extends AppCompatActivity implements GalleryRecyclerView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RecyclerAdapter adapter = new RecyclerAdapter(GalleryActivity.this, getDatas());
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        mRecyclerView.setAdapter(adapter);
        mRecyclerView
                // 设置滑动速度（像素/s）
                .initFlingSpeed(8000)
                // 设置页边距和左右图片的可见宽度，单位px
                .initPageParams(OsUtil.dpToPx(254),
                        OsUtil.dpToPx(254),
                        OsUtil.dpToPx(16))
                // 设置切换动画的参数因子
                .setAnimFactor(0.1f)
